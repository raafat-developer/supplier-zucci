<template>
  <Teleport to="body">
    <Transition name="modal">
      <div v-if="modal.show" class="fixed inset-0 z-[500] flex items-center justify-center" @click.self="modal.close">
        <div class="absolute inset-0 bg-white/35 backdrop-blur-sm" />
        <div class="relative bg-background rounded-xl border border-border shadow-2xl overflow-hidden flex flex-col" :style="{ width: modal.width || '90vw', maxWidth: modal.maxWidth || '560px', maxHeight: '90vh' }">
