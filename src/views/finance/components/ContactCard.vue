<template>
  <div class="flex items-center gap-4 p-4 rounded-xl border bg-white-10">
    <img
    ...
    <div class="flex-1 min-w-0">
      <p class="font-semibold text-sm">Sara Medhat</p>
      <p class="text-xs text-muted-foreground">Senior Partnership Manager</p>
    </div>
    <div class="flex items-center gap-2">
      <button
        @click="$emit('message')"
        class="size-9 flex items-center justify-center rounded-lg border border-border hover:bg-accent transition-colors"
        title="Message"
      >
